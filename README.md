...
Data for current and prospective hydrogen production is derived from the IEA hydrogen project database and an exhaustive internet review (ended in october 2025). This data can be found in the _H2_Production_Current&Future.xlsx_ file. 
More details on the data are provided in the associated article.

This data may be cited with this DOI: https://doi.org/10.5281/zenodo.19368738
